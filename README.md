...
Файли `__init.py__` вказують, що вміст директорії містить в собі модулі python, а не довільні файли. Додаткову інформацію про створення пакетів nта оформлення конфігураційного файлу пакету `pyproject.toml` можна подивитись в офіційній документації python про [модулі](https://docs.python.org/3/tutorial/modules.html) та [пакети](https://packaging.python.org/en/latest/tutorials/packaging-projects/).
...
- [Knowledge Hub from Olympus](https://evidentscientific.com/en/microscope-resource/knowledge-hub)
- [Huygens Imaging Academy from Scientific Volume Imaging](https://svi.nl/Huygens-Imaging-Academy)
